...
export default async function AboutPage() {
  ...
  const [texts, ticketsData, pageData] = await Promise.all([
    getAllTexts(),
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <div className="bg-white rounded-sm p-6">
                ...
                <p className="text-primary leading-relaxed">
                  Vi strävar efter att främja förståelse och uppskattning av
                  astrologi som både konst och vetenskap, och skapa dialog
                  mellan praktiker och forskare med högsta standard inom
              ...
              <div className="bg-white rounded-sm p-6">
                ...
                <p className="text-primary leading-relaxed">
                  Att skapa en inkluderande plattform där astrologins rika
                  tradition möter modern forskning och innovation, och där
                  deltagare kan dela kunskap och erfarenheter i en inspirerande
                  miljö.
                </p>
              </div>
            </div>
            ...
            <div className="bg-primary-dark rounded-sm p-6 sm:p-8 text-center">
              ...
              <p className="text-white/90 text-lg leading-relaxed mb-6">
                Konferensen erbjuder en unik möjlighet att träffa experter inom
                astrologi, delta i workshops och föreläsningar, samt bygga
                nätverk med likasinnade från hela världen.
              </p>
